 ...
 * Original file: D:\\Android\\workspace\\MusicPlus\\src\\com\\andrew\\apolloMod\\IApolloService.aidl
 */
package com.andrew.apolloMod;
public interface IApolloService extends android.os.IInterface
{
/** Local-side IPC implementation stub class. */
public static abstract class Stub extends android.os.Binder implements com.andrew.apolloMod.IApolloService
{
private static final java.lang.String DESCRIPTOR = "com.andrew.apolloMod.IApolloService";
...
/**
 * Cast an IBinder object into an com.andrew.apolloMod.IApolloService interface,
 * generating a proxy if needed.
 */
public static com.andrew.apolloMod.IApolloService asInterface(android.os.IBinder obj)
{
if ((obj==null)) {
return null;
}
android.os.IInterface iin = obj.queryLocalInterface(DESCRIPTOR);
if (((iin!=null)&&(iin instanceof com.andrew.apolloMod.IApolloService))) {
return ((com.andrew.apolloMod.IApolloService)iin);
}
return new com.andrew.apolloMod.IApolloService.Stub.Proxy(obj);
}
...
case TRANSACTION_getIdFromPath:
{
data.enforceInterface(DESCRIPTOR);
java.lang.String _arg0;
_arg0 = data.readString();
long _result = this.getIdFromPath(_arg0);
reply.writeNoException();
...
case TRANSACTION_getAlbumBitmap:
{
data.enforceInterface(DESCRIPTOR);
android.graphics.Bitmap _result = this.getAlbumBitmap();
reply.writeNoException();
if ((_result!=null)) {
reply.writeInt(1);
...
long _arg0;
_arg0 = data.readLong();
this.removeFromFavorites(_arg0);
reply.writeNoException();
return true;
}
...
private static class Proxy implements com.andrew.apolloMod.IApolloService
{
...
@Override public long getIdFromPath(java.lang.String path) throws android.os.RemoteException
{
android.os.Parcel _data = android.os.Parcel.obtain();
android.os.Parcel _reply = android.os.Parcel.obtain();
long _result;
...
_data.writeInterfaceToken(DESCRIPTOR);
_data.writeString(path);
mRemote.transact(Stub.TRANSACTION_getIdFromPath, _data, _reply, 0);
_reply.readException();
...
@Override public android.graphics.Bitmap getAlbumBitmap() throws android.os.RemoteException
{
android.os.Parcel _data = android.os.Parcel.obtain();
android.os.Parcel _reply = android.os.Parcel.obtain();
...
try {
_data.writeInterfaceToken(DESCRIPTOR);
mRemote.transact(Stub.TRANSACTION_getAlbumBitmap, _data, _reply, 0);
_reply.readException();
if ((0!=_reply.readInt())) {
...
@Override public void notifyChange(java.lang.String what) throws android.os.RemoteException
{
android.os.Parcel _data = android.os.Parcel.obtain();
android.os.Parcel _reply = android.os.Parcel.obtain();
try {
...
@Override public void addToFavorites(long id) throws android.os.RemoteException
{
android.os.Parcel _data = android.os.Parcel.obtain();
android.os.Parcel _reply = android.os.Parcel.obtain();
try {
...
@Override public void removeFromFavorites(long id) throws android.os.RemoteException
{
android.os.Parcel _data = android.os.Parcel.obtain();
android.os.Parcel _reply = android.os.Parcel.obtain();
try {
...
static final int TRANSACTION_getIdFromPath = (android.os.IBinder.FIRST_CALL_TRANSACTION + 2);
...
static final int TRANSACTION_getAlbumBitmap = (android.os.IBinder.FIRST_CALL_TRANSACTION + 16);
...
static final int TRANSACTION_notifyChange = (android.os.IBinder.FIRST_CALL_TRANSACTION + 25);
...
static final int TRANSACTION_addToFavorites = (android.os.IBinder.FIRST_CALL_TRANSACTION + 33);
static final int TRANSACTION_removeFromFavorites = (android.os.IBinder.FIRST_CALL_TRANSACTION + 34);
static final int TRANSACTION_isFavorite = (android.os.IBinder.FIRST_CALL_TRANSACTION + 35);
static final int TRANSACTION_toggleFavorite = (android.os.IBinder.FIRST_CALL_TRANSACTION + 36);
}
...
public long getIdFromPath(java.lang.String path) throws android.os.RemoteException;
...
public android.graphics.Bitmap getAlbumBitmap() throws android.os.RemoteException;
...
public void notifyChange(java.lang.String what) throws android.os.RemoteException;
...
public void addToFavorites(long id) throws android.os.RemoteException;
public void removeFromFavorites(long id) throws android.os.RemoteException;
