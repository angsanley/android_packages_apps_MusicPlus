...
import id.angsanley.musicplus.AppEULA;
...
public class MusicLibrary extends Activity implements ServiceConnection {
    ...
    protected void onCreate(Bundle icicle) {
        ...
        versionManager.setVersionContentUrl("http://angsanley.ml/musicplus/downloads/latest.txt"); 
        versionManager.setUpdateUrl("http://angsanley.ml/musicplus/downloads/latest.apk");
